package com.ci.project.repository;

import com.ci.project.CiProjectApp;
import com.ci.project.config.Constants;
import com.ci.project.config.audit.AuditEventConverter;
import com.ci.project.domain.PersistentAuditEvent;
...
import static com.ci.project.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
